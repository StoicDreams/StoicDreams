<webui-data data-page-title="Employee Handbook" data-page-subtitle=""></webui-data>
...
<webui-tabs pad="var(--padding)" vertical transition-timing="200" data-subscribe="session-handbook-tab-index:setTab">
    ...
    <webui-content slot="content" src="/d/content/employee/handbook/mission-and-values.md"></webui-content>
    <webui-button align="left" slot="tabs">Hiring Philosophy</webui-button>
    <webui-content slot="content" src="/d/content/employee/handbook/hiring-philosophy.md"></webui-content>
    <webui-button align="left" slot="tabs">Compensation & Salary</webui-button>
    <webui-content slot="content" src="/d/content/employee/handbook/compensation.md"></webui-content>
    <webui-button align="left" slot="tabs">Remote Work & Flexibility</webui-button>
    <webui-content slot="content" src="/d/content/employee/handbook/remote-first.md"></webui-content>
    <webui-button align="left" slot="tabs">Work-Life Balance</webui-button>
    <webui-content slot="content" src="/d/content/employee/handbook/work-life-balance.md"></webui-content>
    <webui-button align="left" slot="tabs">Open Source & Public Good</webui-button>
    <webui-content slot="content" src="/d/content/employee/handbook/public-good.md"></webui-content>
    <webui-button align="left" slot="tabs">Anti-Harassment & Inclusion</webui-button>
    <webui-content slot="content" src="/d/content/employee/handbook/anti-harassment.md"></webui-content>
    <webui-button align="left" slot="tabs">Learning & Development</webui-button>
    <webui-content slot="content" src="/d/content/employee/handbook/learning.md"></webui-content>
    <webui-button align="left" slot="tabs">Decision-Making & Transparency</webui-button>
    <webui-content slot="content" src="/d/content/employee/handbook/transparency.md"></webui-content>
    <webui-button align="left" slot="tabs">Exit Philosophy</webui-button>
    <webui-content slot="content" src="/d/content/employee/handbook/exit.md"></webui-content>
</webui-tabs>
